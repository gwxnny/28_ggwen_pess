<?php
	...
	if($btnDispatchClicked==true){
		...
		foreach($patrolcarDispatched as $eachCarId){
			...
			$sql="INSERT INTO `dispatch`(`incident_id`, `patrolcar_id`, `time_disptached`) VALUES (" . $incidentId . ",'" . $eachCarId . "',now())";
...
<div class="container" style="width:900px">
  ...
  <section class="mt-3">
	...
	<div class="form-group row">
        <label for="patrolCar" class="col-sm-4 col-form-label">Choose Patrol Car</label>
        <div class="col-sm-8">
